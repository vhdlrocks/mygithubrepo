...
def load_cert():
    ...
    ser.write(cmd)
    waiting_response('> ')
    ser.write(ssl_ca_pem_certificat)
    waiting_response('OK')
...
def get_test_website():
    print('=================================')
    print('Perform GET test using https://sites.google.com/view/testsite101023/home')
    if use_tls:
        print(r'using TLS.')
        load_cert()
    website = 'https://remotecontroller.z13.web.core.windows.net/'
    cmd = "at+sqnhttpcfg=1,\"https://sites.google.com/view/testsite101023/home\"" + r
    cmd = "at+sqnhttpcfg=1,\"https://sites.google.com/view/testsite101023/home\"" + r
    
    # cmd = "at+sqnhttpcfg=1,\"https://sites.google.com/view/testsite101023\"" + r
    ser.write(cmd)
    waiting_response('OK')
    # cmd = "AT+SQNHTTPQRY=1,0,\"/home\"" + r
    cmd = "AT+SQNHTTPQRY=1,0,\"\"" + r
    ser.write(cmd)
    waiting_response('OK')
    get_line_include('+SQNHTTPRING: ')
    cmd = "AT+SQNHTTPRCV=1" + r
