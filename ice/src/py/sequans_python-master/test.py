...
# ser = serial.Serial(uart0_at, uart0_at_speed, timeout=0.5, parity=serial.PARITY_NONE, rtscts=True)  # open serial port
ser = serial.Serial(timeout=0.5, parity=serial.PARITY_NONE, rtscts=True)  # open serial port
ser.baudrate = 115200
ser.port = 'COM7'
ser.open()
