...
# uart0_at = "/dev/ttyUSB0"                # section for AT0 channel configuration
# uart0_at_speed = 115200
channel0_at = serial.Serial(timeout=0.5, parity=serial.PARITY_NONE, rtscts=True)  # open serial port
channel0_at.baudrate = 115200
channel0_at.port = 'COM7'
