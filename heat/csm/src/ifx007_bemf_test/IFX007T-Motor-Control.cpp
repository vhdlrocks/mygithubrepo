...
IFX007TMotorControl::IFX007TMotorControl(void)
{
    ...
    // _PinAssignment[INPUTPIN][0] = OCR1A;
    // _PinAssignment[INPUTPIN][1] = OCR1B;
    // _PinAssignment[INPUTPIN][2] = OCR1C;
...
void IFX007TMotorControl::setPwmFrequency(uint8_t pin, uint16_t divisor)
{
    ...
    if (pin == 5 || pin == 6 || pin == 9 || pin == 10) {
        ...
        // TCCR2B = TCCR2B & 0b11111000 | mode; // Only valid for UNO board
    }
}
...
void IFX007TMotorControl::pwm91011configure(int mode)
{
...
void IFX007TMotorControl::pwmSet9(int value)
{
...
// Set PWM to D10
// Argument is PWM between 0 and 255
void IFX007TMotorControl::pwmSet10(int value)
{
    OCR1B=value;   // Set PWM value
    DDRB|=1<<6;    // Set Output Mode B6
    // TCCR1A|=0x20;  // Set PWM value
    TCCR1A|=0x80;  // Set PWM value
}

// Set PWM to D11
// Argument is PWM between 0 and 255
void IFX007TMotorControl::pwmSet11(int value)
{
